    ...
    <div className="space-y-10">
      <section className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl border border-white/10 bg-neutral-950/80 px-6 py-10 shadow-xl shadow-black/40 md:px-12">
        <div className="pointer-events-none absolute inset-0 opacity-30">
          <div className="absolute left-[-6rem] top-[-4rem] h-64 w-64 rounded-full bg-violet-600/30 blur-3xl" />
          <div className="absolute right-[-4rem] top-10 h-56 w-56 rounded-full bg-cyan-500/25 blur-3xl" />
        </div>
        ...
        <div className="relative grid gap-10 md:grid-cols-5 md:items-center">
          <div className="space-y-5 md:col-span-3">
            ...
            <h1 className="text-4xl font-black leading-tight tracking-tight text-white sm:text-5xl md:text-6xl">
              <span className="bg-gradient-to-r from-violet-200 via-sky-200 to-emerald-200 bg-clip-text text-transparent drop-shadow-[0_10px_40px_rgba(124,58,237,0.35)]">
                {profile.name}
              </span>
            </h1>
            ...
            <div className="flex flex-wrap gap-3">
              <a className="group inline-flex items-center gap-2 rounded-full border border-violet-400/60 px-4 py-2 text-sm font-medium text-slate-100 transition hover:-translate-y-0.5 hover:border-violet-200 hover:bg-violet-500/10 hover:text-white" href={profile.links.resume} target="_blank">
                <span>Resume</span>
              </a>
          ...
          <div className="relative flex items-center justify-center md:col-span-2">
            <div className="absolute inset-0 animate-pulse rounded-full bg-gradient-to-br from-violet-500/20 via-sky-400/15 to-emerald-300/15 blur-3xl" />
            <div className="relative h-48 w-48 overflow-hidden rounded-full border border-white/10 bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-800 shadow-[0_25px_60px_rgba(0,0,0,0.5)] md:h-56 md:w-56">
              ...
              <div className="absolute inset-2 rounded-full border border-white/10 bg-gradient-to-br from-violet-500/10 via-neutral-900 to-cyan-500/10" />
              {hasPhoto ? (
                <Image
                  src={profile.photo}
                  alt={profile.name}
